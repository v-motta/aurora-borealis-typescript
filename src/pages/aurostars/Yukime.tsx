...
const Yukime = () => {
  return (
    <PageAurostar
      ...
      img="https://aurora-imagens.s3.sa-east-1.amazonaws.com/aurostars/vtubers/yukime-transparent.webp"
      bgName="yukime"
      ...
      followers="600+"
      linkLojaAurostar="https://loja.aurorabgs.com/pt-br/?s=Yukime&mfn_livesearch"
    />
  );
};
