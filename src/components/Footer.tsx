  ...
  return (
    <div className="gray-bg d-flex flex-column flex-lg-row align-items-center justify-content-lg-between text-white py-5 px-4 position-relative">
      <div className="d-flex align-items-center mb-2 mb-lg-0">
        <span className="fs-5 fst-italic color-footer">&#x00A9; Aurora Borealis 2019 - 2023</span>
      </div>
      <div className="d-flex flex-column flex-lg-row align-items-center">
        <span className="me-lg-4 mb-3 mb-lg-0 fs-6 color-footer">contato@aurorabgs.com</span>
